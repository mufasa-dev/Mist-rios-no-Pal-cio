...
Scene_Map.prototype.createMenuButton = function() {
    ...
    this._menuButton.x = Graphics.boxWidth - this._menuButton.width + 80;
    this._menuButton.y = this.buttonY() - 50;
    this._menuButton.visible = false;
...
Scene_MenuBase.prototype.createCancelButton = function() {
    ...
    this._cancelButton.x = Graphics.boxWidth - this._cancelButton.width + 3;
    this._cancelButton.y = this.buttonY() + 20;
...
Scene_Battle.prototype.createCancelButton = function() {
    ...
    this._cancelButton.y = this.buttonY() + 200;
    this.addWindow(this._cancelButton);
};
